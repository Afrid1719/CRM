...
export default function Index({ auth, page }) {
    const { roles, isAdmin, isUser, isGuest } = useRoles();
                                        ...
                                        <tr key={user.id}>
                                            ...
                                            <td className="p-4 border-b border-blue-gray-50">
                                                <div className="flex items-center gap-3">
                                                    <p className="block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-normal opacity-70">
                                                        {isAdmin(user.role) ? (
                                                            <span className="bg-red-600 text-white text-xs font-medium px-2.5 py-0.5 rounded-sm">
                                                                {
                                                                    roles[
                                                                        user
                                                                            .role
                                                            ...
                                                            <span className="bg-blue-600 text-white text-xs font-medium px-2.5 py-0.5 rounded-sm">
                                                                {
                                                                    roles[
                                                                        user
                                                                            .role
                                                            ...
                                                            <span className="bg-yellow-400 text-gray-900 text-xs font-medium px-2.5 py-0.5 rounded-sm">
                                                                {
                                                                    roles[
                                                                        user
                                                                            .role
